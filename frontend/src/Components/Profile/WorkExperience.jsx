      ...
      <div className={styles.WorkExperience__Experiences}>
        <div className={styles.WorkExperience__Experiences__First}>
          ...
          >
            ...
            <li className={styles.Responsibilities}>
              Assembled a semantic parser to work along with the user's natural
              language for a chatbot.
            </li>
            <li className={styles.Responsibilities}>
        ...
        <div className={styles.WorkExperience__Experiences__Second}>
          ...
          >
            Tech Stack:{" "}
            <em style={{ color: "#64FFDA" }}> SQL, HTML5, CSS, JavaScript </em>
            <br />
          </p>
          <p
            style={{
          ...
          >
            ...
            <li className={styles.Responsibilities}>
              Optimized a real-time chat system for admin and users using AJAX.
            </li>
            <li className={styles.Responsibilities}>
              Secured the database to store the user and admin information such
              as passwords, chats, and queries using SQL.
            </li>
          </ul>
        </div>
      </div>
