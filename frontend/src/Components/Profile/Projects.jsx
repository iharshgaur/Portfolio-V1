                  ...
                  <div className={classes.paper}>
                    ...
                    <p id="transition-modal-description">
                      ...
                      <ul>
                        ...
                        <li>
                          Modified the backend architecture on Mongo Atlas Cloud
                        </li>
                      </ul>
                    </p>
                ...
                <Fade in={open3}>
                  <div className={classes.paper}>
                    ...
                    <p id="transition-modal-description">
                      ...
                      <ul>
                        <li>
                          Programmed and deployed the API that could handle the
                          user queries.
                        </li>
                        <li>
                          Programmed and deployed the API that could handle the
                ...
                <Fade in={open4}>
                  <div className={classes.paper}>
                    ...
                    <p id="transition-modal-description">
                      ...
                      <ul>
                        <li>
                          Coded the landing page of the website and optimized it
                          for SEO using publicly available technologies
                        </li>
                        <li>
